...
import { Activity, ArrowUpRight, BookOpenCheck, Compass, CreditCard, Gift, LogOut, MessageSquareText, RefreshCw, Search, Share2, Timer, UserCheck, UserPlus, Users } from 'lucide-react';
    ...
    <main className="mx-auto min-h-screen max-w-[1500px] px-4 py-5 sm:px-7 lg:px-10">
      <header className="flex flex-col gap-5 border-b border-neutral-200 pb-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href="/admin/catalog" className="flex items-center gap-2 rounded-xl border border-neutral-200 bg-white px-3 py-2 text-sm font-medium hover:bg-neutral-50"><BookOpenCheck className="size-4" /> Food catalogue</Link>
